...
CS graduate based in the UK, I'm currently working towards a career in **IT and Cloud support**. I have a background spanning full-stack development, robotics programming, and hands-on technical work and I'm multilingual in English, Italian, and Twi.
...
|---|---|---|
| [Home IT Support Lab](https://github.com/serKwesi/homelab-it-support) | Self-built home lab simulating Tier 1/2 IT support: Active Directory, OU/group design, GPOs | | VirtualBox, Windows Server, Active Directory, Group Policy |
